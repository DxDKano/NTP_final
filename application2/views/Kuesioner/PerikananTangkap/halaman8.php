				...
				<div class="card">
					<div class="card-body">
						...
						<table class="table table-sm table-bordered small">
							...
							<tr>
								<th scope="col" class="table-secondary">VIII. CATATAN</th>
							</tr>
							</thead>
							<tbody>
							<tr>
								<td>
									...
									<textarea id="b8" class="form-control" style="height: 100px" ><?php echo $sub['catatan']?></textarea>
								</td>
							</tr>
							</tbody>
						</table>
						...
						<div id="footernotif" class="text-center">
							<button id="backBtn" type="button" class="btn btn-secondary" data-url="<?php echo base_url("TanamanPangan/halaman8"
									."?tahun={$sub['tahun']}"
									."&id_prov={$sub['id_prov']}"
									."&id_kab={$sub['id_kab']}"
									."&id_kec={$sub['id_kec']}"
...
<script>
	...
	$(document).ready(()=>{
		...
		$('#submitBtn, #backBtn, .halaman-tabs').on('click',function (e) {
			...
			setTimeout(function (){
				$.ajax({
					url: `<?php echo base_url('PerikananTangkap/submithalaman8')?>`,
					type: 'POST',
