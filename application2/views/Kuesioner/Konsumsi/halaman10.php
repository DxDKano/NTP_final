...
<main id="main" class="main">
				...
				<div class="card">
					<div class="card-body">
						...
						<table class="table table-sm table-bordered small">
							...
							<tbody>
							<tr>
								<td class="table-secondary" colspan="4" >A.11. Lemak & Minyak</td>
								<td class="table-secondary"><input id="b4_a_11_total" type="number" class="form-control" value="<?php echo $sub['b4_a11_total']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok4a11; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b4_a_11">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b4_a_11" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
							<tr>
								<td class="table-secondary" colspan="4" >A.12. Bahan Makanan Lainnya</td>
								<td class="table-secondary"><input id="b4_a_12_total" type="number" class="form-control" value="<?php echo $sub['b4_a12_total']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok4a12; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b4_a_12">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b4_a_12" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
	...
	<datalist id="list-b4-a-11">
		<?php foreach ($list_jenis_barang_b4_a_11 as $item) : ?>
		<option><?php echo $item["nama"] ?></option>
		<?php endforeach; ?>
	</datalist>

	<datalist id="list-b4-a-12">
		<?php foreach ($list_jenis_barang_b4_a_12 as $item) : ?>
			<option><?php echo $item["nama"] ?></option>
		<?php endforeach; ?>
	</datalist>
...
<script>
	...
	const list_jenis_barang = {
		b4_a_11 : <?php echo json_encode($list_jenis_barang_b4_a_11) ?>,
		b4_a_12 : <?php echo json_encode($list_jenis_barang_b4_a_12) ?>
	}
	...
	const state={
		...
		b4_a_12:[],
		b4_del:[],
		b4_a_11_total:<?php echo $sub['b4_a11_total']?>,
		b4_a_12_total:<?php echo $sub['b4_a12_total']?>,
		b4_a_total:<?php echo $sub['b4_a_total']?>,

		b4_a_11_total_auto: 0,
		b4_a_12_total_auto: 0,
		b4_a_total_auto: 0,

	}
	//ambil data blok 4 a 11
	<?php foreach ($sub_b4_a_11 as $item): ?>
	state.b4_a_11.push({
	...
	state.b4_a_11_total_auto +=<?php echo $item['b4_k5']?:'0' ?>;
	state.b4_a_total_auto +=<?php echo $item['b4_k5']?:'0' ?>;
	<?php endforeach; ?>
	//ambil data blok 4 a 12
	<?php foreach ($sub_b4_a_12 as $item): ?>
	state.b4_a_12.push({
		p1:'<?php echo $item['b4_k1'] ?>',
		p1b:'<?php echo $item['b4_k1b'] ?>',
		p2:'<?php echo $item['b4_k2'] ?>',
	...
	state.b4_a_12_total_auto +=<?php echo $item['b4_k5']?:'0' ?>;
	state.b4_a_total_auto +=<?php echo $item['b4_k5']?:'0' ?>;
	<?php endforeach; ?>
	...
	$(document).ready(()=>{
		...
		onChangeTotal('a','11')
		onChangeClass('b4','a','11')
		actionTambahBaris('b4','a','11')
		onChangeAutocomplete(`b4-a-11-auto`,`b4_a_11`)
		onChangeTotal('a','12')
		onChangeClass('b4','a','12')
		actionTambahBaris('b4','a','12')
		onChangeAutocomplete(`b4-a-12-auto`,`b4_a_12`)
