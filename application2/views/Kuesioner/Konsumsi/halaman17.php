...
<main id="main" class="main">
				...
				<div class="card">
					<div class="card-body">
						...
						<table class="table table-sm table-bordered small">
							...
							<tbody>
							<tr>
								<td class="table-secondary" colspan="4" >B.3. Sandang Anak-anak</td>
								<td class="table-secondary"><input id="b5_b_3_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_b3_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_b_3_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_b3_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok5b3; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b5_b_3">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b5_b_3" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
							<tr>
								<td class="table-secondary" colspan="4" >B.4. Barang Pribadi & Sandang Lain</td>
								<td class="table-secondary"><input id="b5_b_4_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_b4_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_b_4_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_b4_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok5b4; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b5_b_4">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b5_b_4" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
	...
	<datalist id="list-b5-b-3">
		<?php foreach ($list_jenis_barang_b5_b_3 as $item) : ?>
		<option><?php echo $item["nama"] ?></option>
		<?php endforeach; ?>
	</datalist>

	<datalist id="list-b5-b-4">
		<?php foreach ($list_jenis_barang_b5_b_4 as $item) : ?>
			<option><?php echo $item["nama"] ?></option>
		<?php endforeach; ?>
	</datalist>
...
<script>
	...
	const list_jenis_barang = {
		b5_b_3 : <?php echo json_encode($list_jenis_barang_b5_b_3) ?>,
		b5_b_4 : <?php echo json_encode($list_jenis_barang_b5_b_4) ?>,
	}
	...
	const state={
		...
		b5_b_4:[],
		b5_del:[],
		b5_b_3_total_bln:<?php echo $sub['b5_b3_total_bln']?>,
		b5_b_3_total_thn:<?php echo $sub['b5_b3_total_thn']?>,
		b5_b_4_total_bln:<?php echo $sub['b5_b4_total_bln']?>,
		b5_b_4_total_thn:<?php echo $sub['b5_b4_total_thn']?>,
		b5_b_total_bln:<?php echo $sub['b5_b_total_bln']?>,
		b5_b_total_thn:<?php echo $sub['b5_b_total_thn']?>,

		b5_b_3_total_bln_auto:0,
		b5_b_3_total_thn_auto:0,
		b5_b_4_total_bln_auto:0,
		b5_b_4_total_thn_auto:0,
		b5_b_total_bln_auto:0,
		b5_b_total_thn_auto:0,

	}
	//ambil data blok 5 b 3
	<?php foreach ($sub_b5_b_3 as $item): ?>
	state.b5_b_3.push({
	...
	state.b5_b_3_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_b_3_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	state.b5_b_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_b_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	<?php endforeach; ?>
	//ambil data blok 5 b 4
	<?php foreach ($sub_b5_b_4 as $item): ?>
	state.b5_b_4.push({
		p1:'<?php echo $item['b5_k1'] ?>',
		p1b:'<?php echo $item['b5_k1b'] ?>',
		p2:'<?php echo $item['b5_k2'] ?>',
	...
	state.b5_b_4_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_b_4_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	state.b5_b_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_b_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	<?php endforeach; ?>
	...
	$(document).ready(()=>{
		...
		//onChangeTotal('b')
		onChangeTotal('b','3')
		onChangeClass('b5','b','3')
		actionTambahBaris('b5','b','3')
		onChangeAutocomplete(`b5-b-3-auto`,`b5_b_3`)
		onChangeTotal('b','4')
		onChangeClass('b5','b','4')
		actionTambahBaris('b5','b','4')
		onChangeAutocomplete(`b5-b-4-auto`,`b5_b_4`)
