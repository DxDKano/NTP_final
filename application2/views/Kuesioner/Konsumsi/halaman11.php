				...
				<div class="card">
					<div class="card-body">
						...
						<table class="table table-sm table-bordered small">
							...
							<tbody>
							<tr>
								<td class="table-secondary" colspan="4" >B. MAKANAN JADI, MINUMAN, ROKOK, & TEMBAKAU</td>
							...
							<tr>
								<td class="table-secondary" colspan="4" >B.1. Makanan Jadi</td>
							...
							<tr>
								<td class="table-secondary" colspan="4" >B.2. Bahan Minuman/Minuman Tidak Beralkohol</td>
