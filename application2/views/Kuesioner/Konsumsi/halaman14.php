...
<main id="main" class="main">
				...
				<div class="card">
					<div class="card-body">
						...
						<table class="table table-sm table-bordered small">
							...
							<tbody>
							<tr>
								<td class="table-secondary" colspan="4" >A.2. Bahan Bakar, Penerangan & Air</td>
								<td class="table-secondary"><input id="b5_a_2_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_a2_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_a_2_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_a2_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok5a2; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b5_a_2">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b5_a_2" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
							<tr>
								<td class="table-secondary" colspan="4" >A.3. Perlengkapan Rumah Tangga</td>
								<td class="table-secondary"><input id="b5_a_3_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_a3_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_a_3_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_a3_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok5a3; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b5_a_3">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b5_a_3" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
	...
	<datalist id="list-b5-a-2">
		<?php foreach ($list_jenis_barang_b5_a_2 as $item) : ?>
		<option><?php echo $item["nama"] ?></option>
		<?php endforeach; ?>
	</datalist>

	<datalist id="list-b5-a-3">
		<?php foreach ($list_jenis_barang_b5_a_3 as $item) : ?>
			<option><?php echo $item["nama"] ?></option>
		<?php endforeach; ?>
	</datalist>
...
<script>
	...
	const list_jenis_barang = {
		b5_a_2 : <?php echo json_encode($list_jenis_barang_b5_a_2) ?>,
		b5_a_3 : <?php echo json_encode($list_jenis_barang_b5_a_3) ?>,
	}
	...
	const state={
		...
		b5_a_3:[],
		b5_del:[],
		b5_a_2_total_bln:<?php echo $sub['b5_a2_total_bln']?>,
		b5_a_2_total_thn:<?php echo $sub['b5_a2_total_thn']?>,
		b5_a_3_total_bln:<?php echo $sub['b5_a3_total_bln']?>,
		b5_a_3_total_thn:<?php echo $sub['b5_a3_total_thn']?>,
		b5_a_total_bln:<?php echo $sub['b5_a_total_bln']?>,
		b5_a_total_thn:<?php echo $sub['b5_a_total_thn']?>,

		b5_a_2_total_bln_auto:0,
		b5_a_2_total_thn_auto:0,
		b5_a_3_total_bln_auto:0,
		b5_a_3_total_thn_auto:0,
		b5_a_total_bln_auto:0,
		b5_a_total_thn_auto:0,

	}
	//ambil data blok 5 a 2
	<?php foreach ($sub_b5_a_2 as $item): ?>
	state.b5_a_2.push({
	...
	state.b5_a_2_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_a_2_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	state.b5_a_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_a_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	<?php endforeach; ?>
	//ambil data blok 5 a 3
	<?php foreach ($sub_b5_a_3 as $item): ?>
	state.b5_a_3.push({
		p1:'<?php echo $item['b5_k1'] ?>',
		p1b:'<?php echo $item['b5_k1b'] ?>',
		p2:'<?php echo $item['b5_k2'] ?>',
	...
	state.b5_a_3_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_a_3_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	state.b5_a_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_a_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	<?php endforeach; ?>
	...
	$(document).ready(()=>{
		...
		//onChangeTotal('a')
		onChangeTotal('a','2')
		onChangeClass('b5','a','2')
		actionTambahBaris('b5','a','2')
		onChangeAutocomplete(`b5-a-2-auto`,`b5_a_2`)
		onChangeTotal('a','3')
		onChangeClass('b5','a','3')
		actionTambahBaris('b5','a','3')
		onChangeAutocomplete(`b5-a-3-auto`,`b5_a_3`)
