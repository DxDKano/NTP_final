...
<main id="main" class="main">
				...
				<div class="card">
					<div class="card-body">
						...
						<table class="table table-sm table-bordered small">
							...
							<tbody>
							<tr>
								<td class="table-secondary" colspan="4" >A.4. Ikan Air Tawar/Tambak</td>
								<td class="table-secondary"><input id="b4_a_4_total" type="number" class="form-control" value="<?php echo $sub['b4_a4_total']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok4a4; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b4_a_4">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b4_a_4" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
	...
	<datalist id="list-b4-a-4">
		<?php foreach ($list_jenis_barang_b4_a_4 as $item) : ?>
...
<script>
	...
	const list_jenis_barang = {
		b4_a_4 : <?php echo json_encode($list_jenis_barang_b4_a_4) ?>
	}
	...
	const state={
		...
		b4_a_4:[],
		b4_del:[],
		b4_a_4_total:<?php echo $sub['b4_a4_total']?>,
		b4_a_total:<?php echo $sub['b4_a_total']?>,
		b4_a_4_total_auto:0,
		b4_a_total_auto:0,

	}
	//ambil data blok 4 a 4
	<?php foreach ($sub_b4_a_4 as $item): ?>
	state.b4_a_4.push({
	...
	state.b4_a_4_total_auto +=<?php echo $item['b4_k5']?:'0' ?>;
	...
	$(document).ready(()=>{
		...
		onChangeTotal("a","4")
		onChangeClass('b4','a','4')
		actionTambahBaris('b4','a','4')
		onChangeAutocomplete(`b4-a-4-auto`,`b4_a_4`)
