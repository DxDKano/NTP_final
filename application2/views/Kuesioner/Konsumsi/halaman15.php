...
<main id="main" class="main">
				...
				<div class="card">
					<div class="card-body">
						...
						<table class="table table-sm table-bordered small">
							...
							<tbody>
							<tr>
								<td class="table-secondary" colspan="4" >A.4. Penyelenggaraan Rumah Tangga</td>
								<td class="table-secondary"><input id="b5_a_4_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_a4_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_a_4_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_a4_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok5a4; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b5_a_4">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b5_a_4" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
	...
	<datalist id="list-b5-a-4">
		<?php foreach ($list_jenis_barang_b5_a_4 as $item) : ?>
...
<script>
	...
	const list_jenis_barang = {
		b5_a_4 : <?php echo json_encode($list_jenis_barang_b5_a_4) ?>,
	}
	...
	const state={
		...
		b5_a_4:[],
		b5_del:[],
		b5_a_4_total_bln:<?php echo $sub['b5_a4_total_bln']?>,
		b5_a_4_total_thn:<?php echo $sub['b5_a4_total_thn']?>,
		b5_a_total_bln:<?php echo $sub['b5_a_total_bln']?>,
		b5_a_total_thn:<?php echo $sub['b5_a_total_thn']?>,

		b5_a_4_total_bln_auto:0,
		b5_a_4_total_thn_auto:0,
		b5_a_total_bln_auto:0,
		b5_a_total_thn_auto:0,

	}
	//ambil data blok 5 a 4
	<?php foreach ($sub_b5_a_4 as $item): ?>
	state.b5_a_4.push({
	...
	state.b5_a_4_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_a_4_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	...
	$(document).ready(()=>{
		...
		//onChangeTotal('a')
		onChangeTotal('a','4')
		onChangeClass('b5','a','4')
		actionTambahBaris('b5','a','4')
		onChangeAutocomplete(`b5-a-4-auto`,`b5_a_4`)
