				...
				<div class="card">
					<div class="card-body">
						...
						<div id="footernotif" class="text-center">
							<button id="submitBtn" type="button" class="btn btn-primary" data-url="<?php echo base_url("TanamanPangan/halaman1"
									."?tahun={$sub['tahun']}"
									."&id_prov={$sub['id_prov']}"
									."&id_kab={$sub['id_kab']}"
									."&id_kec={$sub['id_kec']}"
...
<script>
	...
	$(document).ready(()=>{
		...
		$('#submitBtn, .halaman-tabs').on('click',function (e) {
			...
			setTimeout(function (){
				$.ajax({
					url: `<?php echo base_url('TanamanPangan/submithalaman1')?>`,
					type: 'POST',
