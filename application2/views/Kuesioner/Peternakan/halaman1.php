...
<main id="main" class="main">
	...
	<section class="section">
		<form id="blok1Form" action="<?php echo base_url('Peternakan/submitblok1')?>" class="row g-3">
		<div class="row">
				...
				<div class="card">
					<div class="card-body">
						...
						<div id="footernotif" class="text-center">
							<button id="submitBtn" type="button" class="btn btn-primary" data-url="<?php echo base_url("Peternakan/halaman2"
									."?tahun={$sub['tahun']}"
									."&id_prov={$sub['id_prov']}"
									."&id_kab={$sub['id_kab']}"
									."&id_kec={$sub['id_kec']}"
...
<script>
	...
	$(document).ready(()=>{
		...
		$('#submitBtn, .halaman-tabs').on('click',function (e) {
			...
			setTimeout(function (){
				$.ajax({
					url: `<?php echo base_url('Peternakan/submithalaman1')?>`,
					type: 'POST',
