				...
				<div class="card">
					<div class="card-body">
						...
						<table class="table table-sm table-bordered small">
							...
							<tbody>
							<tr>
								<td class="table-secondary" colspan="10" >A. Bibit/Benih</td>
								<td class="table-secondary" colspan="2"><input id="b4_a_total" type="number" class="form-control" value="<?php echo $sub['b4_a_total']?>" ></td>
							...
							<tr>
								<td class="table-secondary" colspan="10" >B. Pupuk & Obat-obatan</td>
								<td class="table-secondary" colspan="2"><input id="b4_b_total" type="number" class="form-control" value="<?php echo $sub['b4_b_total']?>" ></td>
								<td class="table-secondary" colspan="1"></td>
							</tr>
							<tr>
								<td class="table-secondary" colspan="10" >B.1. Pupuk</td>
								<td class="table-secondary" colspan="2"><input id="b4_b_1_total" type="number" class="form-control" value="<?php echo $sub['b4_b1_total']?>" ></td>
								<td class="table-secondary" colspan="1"></td>
							</tr>
							...
							<tr>
								<td class="table-secondary" colspan="10" >B.2. Obat-obatan</td>
								<td class="table-secondary" colspan="2"><input id="b4_b_2_total" type="number" class="form-control" value="<?php echo $sub['b4_b2_total']?>" ></td>
								<td class="table-secondary" colspan="1"></td>
							</tr>
