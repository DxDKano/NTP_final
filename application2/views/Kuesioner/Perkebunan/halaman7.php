				...
				<div class="card">
					<div class="card-body">
						...
						<table class="table table-sm table-bordered small">
							...
							<tbody>
							<tr>
								<td colspan="12" class="table-secondary">F. Upah Buruh</td>
								<td colspan="2" class="table-secondary"><input id="b4_f_total" type="number" class="form-control" value="<?php echo $sub['b4_f_total']?>" ></td>
...
<script>
	const state={
		...
		b4_f:[],
		b4f_del:[],
		b4_f_total:'<?php echo $sub['b4_f_total']?>',
	}
	//ambil data blok 4 f
