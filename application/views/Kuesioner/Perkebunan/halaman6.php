					...
					<div class="card-body">
						...
						<table class="table table-sm table-bordered small">
							...
							<tr>
								...
								<td class="table-secondary" colspan="2"><input id="b4_e_total" type="number" class="form-control" value="<?php echo $sub['b4_e_total']?>" ></td>
...
<script>
	const state={
		...
		b4_e:[],
		b4_del:[],
		b4_e_total:'<?php echo $sub['b4_e_total']?>',
	}
