				...
				<div class="card">
					<div class="card-body">
						...
						<table class="table table-sm table-bordered small">
							...
							<tbody>
							<tr>
								<td colspan="8" class="table-primary">A. Tanaman Tahunan</td>
								<td colspan="1" class="table-primary">
									<input id="b3_a_total" data-key="b3_a_total" type="number" class="form-control sub-val"  value="<?php echo $sub['b3_a_total'] ?>"></td>
								</td>
						...
						<div id="footernotif" class="text-center">
							<button id="backBtn" type="button" class="btn btn-secondary" data-url="<?php echo base_url("Perkebunan/halaman1"
									."?tahun={$sub['tahun']}"
									."&id_prov={$sub['id_prov']}"
									."&id_kab={$sub['id_kab']}"
									."&id_kec={$sub['id_kec']}"
							...
							<button id="submitBtn" type="button" class="btn btn-primary" data-url="<?php echo base_url("Perkebunan/halaman3"
									."?tahun={$sub['tahun']}"
									."&id_prov={$sub['id_prov']}"
									."&id_kab={$sub['id_kab']}"
									."&id_kec={$sub['id_kec']}"
...
<script>
	const state={
		...
		no_komoditas_a:0,
		no_komoditas_b:0,
		b3_a_total:'<?php echo $sub['b3_a_total'] ?>',
		b3_a:[],
		b3_del:[],
	}
	//ambil data blok 3 A
	...
	$(document).ready(()=>{
		...
		$('#b3_a_total').on('change',()=>{
			state.b3_a_total=$('#b3_a_total').val()
		})
		...
		$('#submitBtn, #backBtn, .halaman-tabs').on('click',function (e) {
			...
			setTimeout(function (){
				$.ajax({
					url: `<?php echo base_url('Perkebunan/submithalaman2')?>`,
					type: 'POST',
