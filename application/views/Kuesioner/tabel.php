...
<script>
  ...
  $(document).ready(function() {
    if ($('#monitoring_search').val() == "01") {
      ...
      document.getElementById("kolom_monitoring").innerHTML = '<th class="text-center">Subsektor</th><th class="text-center">Target Pemutakhiran</th><th class="text-center">Target Entri</th><th class="text-center">Realisasi</th><th class="text-center">Persentase</th>';
