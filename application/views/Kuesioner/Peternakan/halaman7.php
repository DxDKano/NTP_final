				...
				<div class="card">
					<div class="card-body">
						...
						<table class="table table-sm table-bordered small">
							...
							<tbody>
							<tr>
								<td class="table-secondary" colspan="10" >F. Upah Buruh</td>
								<td class="table-secondary" colspan="2"><input id="b4f_k6_total" type="number" class="form-control" value="<?php echo $sub['b4f_k6_total']?>" ></td>
...
<script>
	const state={
		...
		b4_f:[],
		b4_del:[],
		b4f_k6_total:'<?php echo $sub['b4f_k6_total']?>',
	}
	...
	$(document).ready(()=>{
		...
		$('#b4f_k6_total').on('change',()=>{
			state.b4f_k6_total=`${$('#b4f_k6_total').val()}`
		})
