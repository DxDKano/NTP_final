				...
				<div class="card">
					<div class="card-body">
						...
						<table class="table table-sm table-bordered small">
							...
							<tbody>
							<tr>
								<td class="table-secondary" colspan="10" >B.2. Pakan Ternak/Unggas</td>
								<td class="table-secondary" colspan="2"><input id="b4b2_k6_total" type="number" class="form-control" value="<?php echo $sub['b4b2_k6_total']?>" ></td>
							...
							<tr>
								<td class="table-secondary" colspan="10" >C. Biaya sewa, Pajak & Pengeluaran Lain</td>
								<td class="table-secondary" colspan="2"><input id="b4c_k6_total" type="number" class="form-control" value="<?php echo $sub['b4c_k6_total']?>" ></td>
								<td class="table-secondary" colspan="1"></td>
							</tr>
...
<script>
	const state={
		...
		b4_c:[],
		b4_del:[],
		b4b2_k6_total:'<?php echo $sub['b4b2_k6_total']?>',
		b4c_k6_total:'<?php echo $sub['b4c_k6_total']?>',
	}
	...
	$(document).ready(()=>{
		...
		$('#b4b2_k6_total').on('change',()=>{
			state.b4b2_k6_total=`${$('#b4b2_k6_total').val()}`
		})
		$('#b4c_k6_total').on('change',()=>{
			state.b4c_k6_total=`${$('#b4c_k6_total').val()}`
		})
