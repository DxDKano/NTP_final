				...
				<div class="card">
					<div class="card-body">
						...
						<table class="table table-sm table-bordered small">
							...
							<tbody>
							<tr>
								<td colspan="13" class="table-secondary">D. Transportasi & Komunikasi</td>
							</tr>
							...
							<tr>
								<td colspan="13" class="table-secondary">E. Barang Modal</td>
							</tr>
						...
						<div id="footernotif" class="text-center">
							<button id="backBtn" type="button" class="btn btn-secondary" data-url="<?php echo base_url("TanamanPangan/halaman3"
									."?tahun={$sub['tahun']}"
									."&id_prov={$sub['id_prov']}"
									."&id_kab={$sub['id_kab']}"
									."&id_kec={$sub['id_kec']}"
...
<script>
	...
	$(document).ready(()=>{
		...
		$('#submitBtn, #backBtn, .halaman-tabs').on('click',function (e) {
			...
			setTimeout(function (){
				$.ajax({
					url: `<?php echo base_url('TanamanPangan/submithalaman4')?>`,
					type: 'POST',
