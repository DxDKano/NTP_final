...
<main id="main" class="main">
						...
						<table class="table table-sm table-bordered small">
							...
							<tr>
								<th scope="col" colspan="<?php echo $colsize ?>" class="table-secondary">
									...
									(SEPTEMBER 2017) DAN SETAHUN (OKTOBER 2016 - SEPTEMBER 2017) YANG BERASAL DARI PEMBELIAN
								</th>
							</tr>
							<tr>
							...
							<tbody>
							<tr>
								<td class="table-secondary" colspan="4" >A. PERUMAHAN, AIR, LISTRIK & BAHAN BAKAR</td>
								<td class="table-secondary"><input id="b5_a_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_a_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_a_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_a_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<tr>
								<td class="table-secondary" colspan="4" >A.1. Biaya Tempat Tinggal</td>
								<td class="table-secondary"><input id="b5_a_1_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_a1_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_a_1_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_a1_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok5a1; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b5_a_1">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b5_a_1" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
	...
	<datalist id="list-b5-a-1">
		<?php foreach ($list_jenis_barang_b5_a_1 as $item) : ?>
...
<script>
	...
	const list_jenis_barang = {
		b5_a_1 : <?php echo json_encode($list_jenis_barang_b5_a_1) ?>,
	}
	...
	const state={
		...
		b5_a_1:[],
		b5_del:[],
		b5_a_1_total_bln:<?php echo $sub['b5_a1_total_bln']?>,
		b5_a_1_total_thn:<?php echo $sub['b5_a1_total_thn']?>,
		b5_a_total_bln:<?php echo $sub['b5_a_total_bln']?>,
		b5_a_total_thn:<?php echo $sub['b5_a_total_thn']?>,

		b5_a_1_total_bln_auto:0,
		b5_a_1_total_thn_auto:0,
		b5_a_total_bln_auto:0,
		b5_a_total_thn_auto:0,

	}
	//ambil data blok 5 a 1
	<?php foreach ($sub_b5_a_1 as $item): ?>
	state.b5_a_1.push({
	...
	state.b5_a_1_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_a_1_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	...
	$(document).ready(()=>{
		...
		onChangeTotal('a')
		onChangeTotal('a','1')
		onChangeClass('b5','a','1')
		actionTambahBaris('b5','a','1')
		onChangeAutocomplete(`b5-a-1-auto`,`b5_a_1`)
