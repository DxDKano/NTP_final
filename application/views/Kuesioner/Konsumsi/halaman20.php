...
<main id="main" class="main">
				...
				<div class="card">
					<div class="card-body">
						...
						<table class="table table-sm table-bordered small">
							...
							<tbody>
							<tr>
								<td class="table-secondary" colspan="4" >D.2. Perlengkapan/Peralatan Pendidikan</td>
								<td class="table-secondary"><input id="b5_d_2_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_d2_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_d_2_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_d2_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok5d2; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b5_d_2">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b5_d_2" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
							<tr>
								<td class="table-secondary" colspan="4" >D.3. Rekreasi/Hiburan</td>
								<td class="table-secondary"><input id="b5_d_3_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_d3_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_d_3_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_d3_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok5d3; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b5_d_3">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b5_d_3" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
	...
	<datalist id="list-b5-d-2">
		<?php foreach ($list_jenis_barang_b5_d_2 as $item) : ?>
			<option><?php echo $item["nama"] ?></option>
		<?php endforeach; ?>
	</datalist>

	<datalist id="list-b5-d-3">
		<?php foreach ($list_jenis_barang_b5_d_3 as $item) : ?>
			<option><?php echo $item["nama"] ?></option>
		<?php endforeach; ?>
	</datalist>
...
<script>
	...
	const list_jenis_barang = {
		b5_d_3 : <?php echo json_encode($list_jenis_barang_b5_d_3) ?>,
		b5_d_2 : <?php echo json_encode($list_jenis_barang_b5_d_2) ?>,
	}
	...
	const state={
		...
		b5_d_2:[],
		b5_del:[],
		b5_d_3_total_bln:<?php echo $sub['b5_d3_total_bln']?>,
		b5_d_3_total_thn:<?php echo $sub['b5_d3_total_thn']?>,
		b5_d_2_total_bln:<?php echo $sub['b5_d2_total_bln']?>,
		b5_d_2_total_thn:<?php echo $sub['b5_d2_total_thn']?>,
		b5_d_total_bln:<?php echo $sub['b5_d_total_bln']?>,
		b5_d_total_thn:<?php echo $sub['b5_d_total_thn']?>,
		b5_d_total_bln:<?php echo $sub['b5_d_total_bln']?>,
		b5_d_total_thn:<?php echo $sub['b5_d_total_thn']?>,

		b5_d_3_total_bln_auto:0,
		b5_d_3_total_thn_auto:0,
		b5_d_2_total_bln_auto:0,
		b5_d_2_total_thn_auto:0,
		b5_d_total_bln_auto:0,
		b5_d_total_thn_auto:0,

	}
	//ambil data blok 5 d 2
	<?php foreach ($sub_b5_d_2 as $item): ?>
	state.b5_d_2.push({
	...
	state.b5_d_2_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_d_2_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	state.b5_d_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_d_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	<?php endforeach; ?>
	//ambil data blok 5 d_3.
	<?php foreach ($sub_b5_d_3 as $item): ?>
	state.b5_d_3.push({
		p1:'<?php echo $item['b5_k1'] ?>',
		p1b:'<?php echo $item['b5_k1b'] ?>',
		p2:'<?php echo $item['b5_k2'] ?>',
	...
	state.b5_d_3_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_d_3_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	state.b5_d_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_d_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	<?php endforeach; ?>
	...
	$(document).ready(()=>{
		...
		//onChangeTotal('d')
		onChangeTotal('d','2')
		onChangeClass('b5','d','2')
		actionTambahBaris('b5','d','2')
		onChangeAutocomplete(`b5-d-2-auto`,`b5_d_2`)
		onChangeTotal('d','3')
		onChangeClass('b5','d','3')
		actionTambahBaris('b5','d','3')
		onChangeAutocomplete(`b5-d-3-auto`,`b5_d_3`)
