...
<main id="main" class="main">
				...
				<div class="card">
					<div class="card-body">
						...
						<table class="table table-sm table-bordered small">
							...
							<tbody>
							<tr>
								<td class="table-secondary" colspan="4" >C.3. Perawatan Jasmani & Kosmetik</td>
								<td class="table-secondary"><input id="b5_c_3_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_c3_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_c_3_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_c3_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok5c3; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b5_c_3">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b5_c_3" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
							<tr>
								<td class="table-secondary" colspan="4" >D. PENDIDIKAN, REKREASI, & OLAHRAGA</td>
								<td class="table-secondary"><input id="b5_d_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_d_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_d_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_d_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<tr>
								<td class="table-secondary" colspan="4" >D.1. Pendidikan</td>
								<td class="table-secondary"><input id="b5_d_1_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_d1_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_d_1_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_d1_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok5d1; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b5_d_1">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b5_d_1" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
	...
	<datalist id="list-b5-c-3">
		<?php foreach ($list_jenis_barang_b5_c_3 as $item) : ?>
		<option><?php echo $item["nama"] ?></option>
		<?php endforeach; ?>
	</datalist>

	<datalist id="list-b5-d-1">
		<?php foreach ($list_jenis_barang_b5_d_1 as $item) : ?>
			<option><?php echo $item["nama"] ?></option>
		<?php endforeach; ?>
	</datalist>
...
<script>
	...
	const list_jenis_barang = {
		b5_c_3 : <?php echo json_encode($list_jenis_barang_b5_c_3) ?>,
		b5_d_1 : <?php echo json_encode($list_jenis_barang_b5_d_1) ?>,
	}
	...
	const state={
		...
		b5_d_1:[],
		b5_del:[],
		b5_c_3_total_bln:<?php echo $sub['b5_c3_total_bln']?>,
		b5_c_3_total_thn:<?php echo $sub['b5_c3_total_thn']?>,
		b5_d_1_total_bln:<?php echo $sub['b5_d1_total_bln']?>,
		b5_d_1_total_thn:<?php echo $sub['b5_d1_total_thn']?>,
		...
		b5_c_3_total_bln_auto:0,
		b5_c_3_total_thn_auto:0,
		b5_d_1_total_bln_auto:0,
		b5_d_1_total_thn_auto:0,
	...
	//ambil data blok 5 c 3
	<?php foreach ($sub_b5_c_3 as $item): ?>
	state.b5_c_3.push({
	...
	state.b5_c_3_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_c_3_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	state.b5_c_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_c_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	<?php endforeach; ?>
	//ambil data blok 5 d_1
	<?php foreach ($sub_b5_d_1 as $item): ?>
	state.b5_d_1.push({
		p1:'<?php echo $item['b5_k1'] ?>',
		p1b:'<?php echo $item['b5_k1b'] ?>',
		p2:'<?php echo $item['b5_k2'] ?>',
	...
	state.b5_d_1_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_d_1_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	...
	$(document).ready(()=>{
		...
		onChangeTotal('c','3')
		onChangeClass('b5','c','3')
		actionTambahBaris('b5','c','3')
		onChangeAutocomplete(`b5-c-3-auto`,`b5_c_3`)
		onChangeTotal('d')
		onChangeTotal('d','1')
		onChangeClass('b5','d','1')
		actionTambahBaris('b5','d','1')
		onChangeAutocomplete(`b5-d-1-auto`,`b5_d_1`)
