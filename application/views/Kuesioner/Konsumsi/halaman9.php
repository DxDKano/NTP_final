...
<main id="main" class="main">
				...
				<div class="card">
					<div class="card-body">
						...
						<table class="table table-sm table-bordered small">
							...
							<tbody>
							<tr>
								<td class="table-secondary" colspan="4" >A.9. Kacang-kacangan</td>
								<td class="table-secondary"><input id="b4_a_9_total" type="number" class="form-control" value="<?php echo $sub['b4_a9_total']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok4a9; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b4_a_9">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b4_a_9" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
							<tr>
								<td class="table-secondary" colspan="4" >A.10. Bumbu-bumbuan</td>
								<td class="table-secondary"><input id="b4_a_10_total" type="number" class="form-control" value="<?php echo $sub['b4_a10_total']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok4a10; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b4_a_10">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b4_a_10" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
	...
	<datalist id="list-b4-a-9">
		<?php foreach ($list_jenis_barang_b4_a_9 as $item) : ?>
		<option><?php echo $item["nama"] ?></option>
		<?php endforeach; ?>
	</datalist>

	<datalist id="list-b4-a-10">
		<?php foreach ($list_jenis_barang_b4_a_10 as $item) : ?>
			<option><?php echo $item["nama"] ?></option>
		<?php endforeach; ?>
	</datalist>
...
<script>
	...
	const list_jenis_barang = {
		b4_a_9 : <?php echo json_encode($list_jenis_barang_b4_a_9) ?>,
		b4_a_10 : <?php echo json_encode($list_jenis_barang_b4_a_10) ?>
	}
	...
	const state={
		...
		b4_a_10:[],
		b4_del:[],
		b4_a_9_total:<?php echo $sub['b4_a9_total']?>,
		b4_a_10_total:<?php echo $sub['b4_a10_total']?>,
		b4_a_total:<?php echo $sub['b4_a_total']?>,

		b4_a_9_total_auto : 0,
		b4_a_10_total_auto : 0,
		b4_a_total_auto : 0,

	}
	//ambil data blok 4 a 9
	<?php foreach ($sub_b4_a_9 as $item): ?>
	state.b4_a_9.push({
	...
	state.b4_a_9_total_auto +=<?php echo $item['b4_k5']?:'0' ?>;
	state.b4_a_total_auto +=<?php echo $item['b4_k5']?:'0' ?>;
	<?php endforeach; ?>
	//ambil data blok 4 a 10
	<?php foreach ($sub_b4_a_10 as $item): ?>
	state.b4_a_10.push({
		p1:'<?php echo $item['b4_k1'] ?>',
		p1b:'<?php echo $item['b4_k1b'] ?>',
		p2:'<?php echo $item['b4_k2'] ?>',
	...
	state.b4_a_10_total_auto +=<?php echo $item['b4_k5']?:'0' ?>;
	state.b4_a_total_auto +=<?php echo $item['b4_k5']?:'0' ?>;
	<?php endforeach; ?>
	...
	$(document).ready(()=>{
		...
		onChangeTotal('a','9')
		onChangeClass('b4','a','9')
		actionTambahBaris('b4','a','9')
		onChangeAutocomplete(`b4-a-9-auto`,`b4_a_9`)
		onChangeTotal('a','10')
		onChangeClass('b4','a','10')
		actionTambahBaris('b4','a','10')
		onChangeAutocomplete(`b4-a-10-auto`,`b4_a_10`)
