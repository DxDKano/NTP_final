...
<main id="main" class="main">
				...
				<div class="card">
					<div class="card-body">
						...
						<table class="table table-sm table-bordered small">
							...
							<tbody>
							<tr>
								<td class="table-secondary" colspan="4" >A. BAHAN MAKANAN</td>
							...
							<tr>
								<td class="table-secondary" colspan="4" >A.1. Padi-padian, Umbi-umbian dan Hasil-hasilnya</td>
								<td class="table-secondary"><input id="b4_a_1_total" type="number" class="form-control" value="<?php echo $sub['b4_a1_total']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							...
							<tr>
								<td class="table-secondary" colspan="4" >A.2. Daging dan Hasil-hasilnya</td>
								<td class="table-secondary"><input id="b4_a_2_total" type="number" class="form-control" value="<?php echo $sub['b4_a2_total']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok4a2; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b4_a_2">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b4_a_2" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
	...
	<datalist id="list-b4-a-2">
		<?php foreach ($list_jenis_barang_b4_a_2 as $item) : ?>
			<option><?php echo $item["nama"] ?></option>
		<?php endforeach; ?>
	</datalist>
...
<script>
	...
	const list_jenis_barang = {
		...
		b4_a_2 : <?php echo json_encode($list_jenis_barang_b4_a_2) ?>
	}
	...
	const state={
		...
		b4_a_2_total:<?php echo $sub['b4_a2_total']?>,
	...
	<?php endforeach; ?>
	//ambil data blok b4_a_2
	<?php foreach ($sub_b4_a_2 as $item): ?>
	state.b4_a_2.push({
		p1:'<?php echo $item['b4_k1'] ?>',
		p1b:'<?php echo $item['b4_k1b'] ?>',
		p2:'<?php echo $item['b4_k2'] ?>',
	...
	state.b4_a_2_total_auto +=<?php echo $item['b4_k5']?:'0' ?>;
	state.b4_a_total_auto +=<?php echo $item['b4_k5']?:'0' ?>;
	<?php endforeach; ?>
	...
	$(document).ready(()=>{
		...
		onChangeClass('b4','a','2')
		actionTambahBaris('b4','a','1')
		actionTambahBaris('b4','a','2')
		onChangeAutocomplete(`b4-a-1-auto`,`b4_a_1`)
		onChangeAutocomplete(`b4-a-2-auto`,`b4_a_2`)
