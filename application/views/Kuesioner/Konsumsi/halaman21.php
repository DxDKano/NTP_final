...
<main id="main" class="main">
				...
				<div class="card">
					<div class="card-body">
						...
						<table class="table table-sm table-bordered small">
							...
							<tbody>
							<tr>
								<td class="table-secondary" colspan="4" >D.4. Olahraga</td>
								<td class="table-secondary"><input id="b5_d_4_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_d4_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_d_4_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_d4_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok5d4; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b5_d_4">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b5_d_4" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
							<tr>
								<td class="table-secondary" colspan="4" >E. TRANSPORTASI, KOMUNIKASI, DAN JASA KEUANGAN</td>
								<td class="table-secondary"><input id="b5_e_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_e_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_e_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_e_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<tr>
								<td class="table-secondary" colspan="4" >E.1. Transportasi</td>
								<td class="table-secondary"><input id="b5_e_1_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_e1_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_e_1_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_e1_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok5e1; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b5_e_1">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b5_e_1" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
							<tr>
								<td class="table-secondary" colspan="4" >E.2. Komunikasi & Pengiriman</td>
								<td class="table-secondary"><input id="b5_e_2_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_e2_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_e_2_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_e2_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok5e2; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b5_e_2">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b5_e_2" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
	...
	<datalist id="list-b5-d-4">
		<?php foreach ($list_jenis_barang_b5_d_4 as $item) : ?>
		<option><?php echo $item["nama"] ?></option>
		<?php endforeach; ?>
	</datalist>

	<datalist id="list-b5-e-1">
		<?php foreach ($list_jenis_barang_b5_e_1 as $item) : ?>
			<option><?php echo $item["nama"] ?></option>
		<?php endforeach; ?>
	</datalist>

	<datalist id="list-b5-e-2">
		<?php foreach ($list_jenis_barang_b5_e_2 as $item) : ?>
			<option><?php echo $item["nama"] ?></option>
		<?php endforeach; ?>
	</datalist>
...
<script>
	...
	const list_jenis_barang = {
		b5_d_4 : <?php echo json_encode($list_jenis_barang_b5_d_4) ?>,
		b5_e_1 : <?php echo json_encode($list_jenis_barang_b5_e_1) ?>,
		b5_e_2 : <?php echo json_encode($list_jenis_barang_b5_e_2) ?>,
	}
	...
	const state={
		...
		b5_e_2:[],
		b5_del:[],
		b5_d_4_total_bln:<?php echo $sub['b5_d4_total_bln']?>,
		b5_d_4_total_thn:<?php echo $sub['b5_d4_total_thn']?>,
		b5_e_1_total_bln:<?php echo $sub['b5_e1_total_bln']?>,
		b5_e_1_total_thn:<?php echo $sub['b5_e1_total_thn']?>,
		b5_e_2_total_bln:<?php echo $sub['b5_e2_total_bln']?>,
		b5_e_2_total_thn:<?php echo $sub['b5_e2_total_thn']?>,
		b5_d_total_bln:<?php echo $sub['b5_d_total_bln']?>,
		b5_d_total_thn:<?php echo $sub['b5_d_total_thn']?>,
		b5_e_total_bln:<?php echo $sub['b5_e_total_bln']?>,
		b5_e_total_thn:<?php echo $sub['b5_e_total_thn']?>,

		b5_d_4_total_bln_auto:0,
		b5_d_4_total_thn_auto:0,
		b5_e_1_total_bln_auto:0,
		b5_e_1_total_thn_auto:0,
		b5_e_2_total_bln_auto:0,
		b5_e_2_total_thn_auto:0,
		b5_d_total_bln_auto:0,
		b5_d_total_thn_auto:0,
		b5_e_total_bln_auto:0,
		b5_e_total_thn_auto:0,

	}
	//ambil data blok 5 d 4
	<?php foreach ($sub_b5_d_4 as $item): ?>
	state.b5_d_4.push({
	...
	state.b5_d_4_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_d_4_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	state.b5_d_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_d_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	<?php endforeach; ?>
	//ambil data blok 5 e_1
	<?php foreach ($sub_b5_e_1 as $item): ?>
	state.b5_e_1.push({
		p1:'<?php echo $item['b5_k1'] ?>',
		p1b:'<?php echo $item['b5_k1b'] ?>',
		p2:'<?php echo $item['b5_k2'] ?>',
	...
	state.b5_e_1_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_e_1_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	state.b5_e_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_e_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	<?php endforeach; ?>
	//ambil data blok 5 e_2
	<?php foreach ($sub_b5_e_2 as $item): ?>
	state.b5_e_2.push({
		p1:'<?php echo $item['b5_k1'] ?>',
		p1b:'<?php echo $item['b5_k1b'] ?>',
		p2:'<?php echo $item['b5_k2'] ?>',
	...
	state.b5_e_2_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_e_2_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	state.b5_e_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_e_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	<?php endforeach; ?>
	...
	$(document).ready(()=>{
		...
		onChangeTotal('d','4')
		onChangeClass('b5','d','4')
		actionTambahBaris('b5','d','4')
		onChangeAutocomplete(`b5-d-4-auto`,`b5_d_4`)
		onChangeTotal('e')
		onChangeTotal('e','1')
		onChangeClass('b5','e','1')
		actionTambahBaris('b5','e','1')
		onChangeAutocomplete(`b5-e-1-auto`,`b5_e_1`)
		onChangeTotal('e','2')
		onChangeClass('b5','e','2')
		actionTambahBaris('b5','e','2')
		onChangeAutocomplete(`b5-e-2-auto`,`b5_e_2`)
