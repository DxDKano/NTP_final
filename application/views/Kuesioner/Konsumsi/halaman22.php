...
<main id="main" class="main">
				...
				<div class="card">
					<div class="card-body">
						...
						<table class="table table-sm table-bordered small">
							...
							<tbody>
							<tr>
								<td class="table-secondary" colspan="4" >E.3. Sarana & Penunjang Transportasi</td>
								<td class="table-secondary"><input id="b5_e_3_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_e3_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_e_3_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_e3_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok5e3; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b5_e_3">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b5_e_3" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
							<tr>
								<td class="table-secondary" colspan="4" >E.4. Jasa Keuangan</td>
								<td class="table-secondary"><input id="b5_e_4_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_e4_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_e_4_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_e4_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok5e4; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b5_e_4">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b5_e_4" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
							<tr>
								<td class="table-secondary" colspan="4" >F. PENGELUARAN LAINNYA</td>
								<td class="table-secondary"><input id="b5_f_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_f_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_f_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_f_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok5f1; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b5_f_1">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b5_f_1" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
	...
	<datalist id="list-b5-e-3">
		<?php foreach ($list_jenis_barang_b5_e_3 as $item) : ?>
			<option><?php echo $item["nama"] ?></option>
		<?php endforeach; ?>
	</datalist>

	<datalist id="list-b5-e-4">
		<?php foreach ($list_jenis_barang_b5_e_4 as $item) : ?>
			<option><?php echo $item["nama"] ?></option>
		<?php endforeach; ?>
	</datalist>

	<datalist id="list-b5-f-1">
		<?php foreach ($list_jenis_barang_b5_f_1 as $item) : ?>
			<option><?php echo $item["nama"] ?></option>
		<?php endforeach; ?>
	</datalist>
...
<script>
	...
	const list_jenis_barang = {
		b5_e_3 : <?php echo json_encode($list_jenis_barang_b5_e_3) ?>,
		b5_e_4 : <?php echo json_encode($list_jenis_barang_b5_e_4) ?>,
		b5_f_1 : <?php echo json_encode($list_jenis_barang_b5_f_1) ?>,
	}
	...
	const state={
		...
		b5_f_1:[],
		b5_del:[],
		b5_e_3_total_bln:<?php echo $sub['b5_e3_total_bln']?>,
		b5_e_3_total_thn:<?php echo $sub['b5_e3_total_thn']?>,
		b5_e_4_total_bln:<?php echo $sub['b5_e4_total_bln']?>,
		b5_e_4_total_thn:<?php echo $sub['b5_e4_total_thn']?>,
		b5_f_1_total_bln:<?php echo $sub['b5_f1_total_bln']?>,
		b5_f_1_total_thn:<?php echo $sub['b5_f1_total_thn']?>,
		b5_e_total_bln:<?php echo $sub['b5_e_total_bln']?>,
		b5_e_total_thn:<?php echo $sub['b5_e_total_thn']?>,
		b5_f_total_bln:<?php echo $sub['b5_f_total_bln']?>,
		b5_f_total_thn:<?php echo $sub['b5_f_total_thn']?>,

		b5_e_3_total_bln_auto:0,
		b5_e_3_total_thn_auto:0,
		b5_e_4_total_bln_auto:0,
		b5_e_4_total_thn_auto:0,
		b5_f_1_total_bln_auto:0,
		b5_f_1_total_thn_auto:0,
		b5_e_total_bln_auto:0,
		b5_e_total_thn_auto:0,
		b5_f_total_bln_auto:0,
		b5_f_total_thn_auto:0,

	}
	//ambil data blok 5 e_3
	<?php foreach ($sub_b5_e_3 as $item): ?>
	state.b5_e_3.push({
	...
	state.b5_e_3_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_e_3_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	state.b5_e_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_e_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	<?php endforeach; ?>
	//ambil data blok 5 e_4
	<?php foreach ($sub_b5_e_4 as $item): ?>
	state.b5_e_4.push({
		p1:'<?php echo $item['b5_k1'] ?>',
		p1b:'<?php echo $item['b5_k1b'] ?>',
		p2:'<?php echo $item['b5_k2'] ?>',
	...
	state.b5_e_4_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_e_4_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	state.b5_e_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_e_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	<?php endforeach; ?>
	//ambil data blok 5 f_1
	<?php foreach ($sub_b5_f_1 as $item): ?>
	state.b5_f_1.push({
		p1:'<?php echo $item['b5_k1'] ?>',
		p1b:'<?php echo $item['b5_k1b'] ?>',
		p2:'<?php echo $item['b5_k2'] ?>',
	...
	state.b5_f_1_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_f_1_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	state.b5_f_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_f_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	<?php endforeach; ?>
	...
	$(document).ready(()=>{
		...
		onChangeTotal('e','3')
		onChangeClass('b5','e','3')
		actionTambahBaris('b5','e','3')
		onChangeAutocomplete(`b5-e-3-auto`,`b5_e_3`)
		onChangeTotal('e','4')
		onChangeClass('b5','e','4')
		actionTambahBaris('b5','e','4')
		onChangeAutocomplete(`b5-e-4-auto`,`b5_e_4`)
		onChangeTotal('f')
		onChangeTotal('f','1')
		onChangeClass('b5','f','1')
		actionTambahBaris('b5','f','1')
		onChangeAutocomplete(`b5-f-1-auto`,`b5_f_1`)
