...
<main id="main" class="main">
				...
				<div class="card">
					<div class="card-body">
						...
						<table class="table table-sm table-bordered small">
							...
							<tbody>
							<tr>
								<td class="table-secondary" colspan="4" >B. SANDANG</td>
								<td class="table-secondary"><input id="b5_b_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_b_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_b_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_b_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<tr>
								<td class="table-secondary" colspan="4" >B.1. Sandang Pria</td>
								<td class="table-secondary"><input id="b5_b_1_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_b1_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_b_1_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_b1_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok5b1; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b5_b_1">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b5_b_1" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
							<tr>
								<td class="table-secondary" colspan="4" >B.2. Sandang Wanita</td>
								<td class="table-secondary"><input id="b5_b_2_total_bln" type="number" class="form-control" value="<?php echo $sub['b5_b2_total_bln']?>" ></td>
								<td class="table-secondary"><input id="b5_b_2_total_thn" type="number" class="form-control" value="<?php echo $sub['b5_b2_total_thn']?>" ></td>
								<td class="table-secondary" colspan="2"></td>
							</tr>
							<?php echo $isianBlok5b2; ?>
							<!-- <i class="bi bi-plus"></i>Tambah -->
							<tr id="tr_tambah_b5_b_2">
								<td colspan="<?php echo $colsize ?>" >
									<button type="button" class="btn btn-outline-secondary" id="btn_tambah_b5_b_2" >
										<i class="bi bi-plus"></i>Tambah
									</button>
								</td>
							</tr>
	...
	<datalist id="list-b5-b-1">
		<?php foreach ($list_jenis_barang_b5_b_1 as $item) : ?>
		<option><?php echo $item["nama"] ?></option>
		<?php endforeach; ?>
	</datalist>

	<datalist id="list-b5-b-2">
		<?php foreach ($list_jenis_barang_b5_b_2 as $item) : ?>
			<option><?php echo $item["nama"] ?></option>
		<?php endforeach; ?>
	</datalist>
...
<script>
	...
	const list_jenis_barang = {
		b5_b_1 : <?php echo json_encode($list_jenis_barang_b5_b_1) ?>,
		b5_b_2 : <?php echo json_encode($list_jenis_barang_b5_b_2) ?>,
	}
	...
	const state={
		...
		b5_b_2:[],
		b5_del:[],
		b5_b_1_total_bln:<?php echo $sub['b5_b1_total_bln']?>,
		b5_b_1_total_thn:<?php echo $sub['b5_b1_total_thn']?>,
		b5_b_2_total_bln:<?php echo $sub['b5_b2_total_bln']?>,
		b5_b_2_total_thn:<?php echo $sub['b5_b2_total_thn']?>,
		b5_b_total_bln:<?php echo $sub['b5_b_total_bln']?>,
		b5_b_total_thn:<?php echo $sub['b5_b_total_thn']?>,

		b5_b_1_total_bln_auto:0,
		b5_b_1_total_thn_auto:0,
		b5_b_2_total_bln_auto:0,
		b5_b_2_total_thn_auto:0,
		b5_b_total_bln_auto:0,
		b5_b_total_thn_auto:0,

	}
	//ambil data blok 5 b 2
	<?php foreach ($sub_b5_b_2 as $item): ?>
	state.b5_b_2.push({
	...
	state.b5_b_2_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_b_2_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	state.b5_b_total_bln_auto +=<?php echo $item['b5_k5']?:'0' ?>;
	state.b5_b_total_thn_auto +=<?php echo $item['b5_k6']?:'0' ?>;
	<?php endforeach; ?>
	//ambil data blok 5 b 2
	<?php foreach ($sub_b5_b_2 as $item): ?>
	state.b5_b_2.push({
	...
	$(document).ready(()=>{
		...
		onChangeTotal('b')
		onChangeTotal('b','1')
		onChangeClass('b5','b','1')
		actionTambahBaris('b5','b','1')
		onChangeAutocomplete(`b5-b-1-auto`,`b5_b_1`)
		onChangeTotal('b','2')
		onChangeClass('b5','b','2')
		actionTambahBaris('b5','b','2')
		onChangeAutocomplete(`b5-b-2-auto`,`b5_b_2`)
